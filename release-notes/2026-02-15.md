...
- **功能更新**
  ...
  - Slack/Discord/Telegram: 支援每頻道ack反應覆蓋
  - Cron/Gateway: 支援完成run webhook遞送開關與獨立webhook认证
...
- **相關**：DiscordComponents v2 UI + embeds passthrough + exec approval UX 改進
...
- **用途**：使 buildFtsQuery Unicode-aware，這樣非 ASCII 查詢 (包括 CJK) 產生關鍵字記號而不是回退到僅 vectoer search
...
| 錯誤修復 | 10+ | Telegram DM、Discord Session、Memory QMD |
